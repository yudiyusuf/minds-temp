                        ...
                        <div class="row justify-content-center mb-5">
                            <div class="col-sm-3">
                                <div class="maintenance-img">
                                    <img src="<?php echo e(URL::asset('assets/images/maintenance.png')); ?>" alt="" class="img-fluid mx-auto d-block" max-width="80%">
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="dropdown float-end">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <form action="<?php echo e(url('/delete-dashboard', $dashboard->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                            ...
                                            <h5 class="font-size-15 text-uppercase mt-4"><?php echo e($dashboard->name); ?></h5>
                                           <p class="text-muted mb-0"><a href="<?php echo e($dashboard->url); ?>" target="_blank" rel="noopener noreferrer"><?php echo e($dashboard->description); ?></a></p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo e(route('tambahdashboard')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" autofocus placeholder="Contoh : Sanivokasi">
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" autofocus placeholder="Contoh : Website PT. Cahaya Sani Vokasi">
...
unset($__errorArgs, $__bag); ?>" id="url" name="url" autofocus placeholder="Contoh : https://sanivokasi.com">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\minds\resources\views/minds.blade.php ENDPATH**/ ?>