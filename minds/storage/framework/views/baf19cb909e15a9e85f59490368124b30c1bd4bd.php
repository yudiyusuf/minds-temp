        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">Diinformasikan Untuk Saya<span class="text-muted fw-normal ms-2">(<?php echo e($datacount); ?>)</span></h5>
                         </div>
                     </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\minds\resources\views/internalmemo/internal-memo-mylistforme.blade.php ENDPATH**/ ?>