                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-10">
                                ...
                                <input id="memoname" name="memoname" type="text" class="form-control"  placeholder="Judul Internal Memo" value="{{ old('memoname') }}" required>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="nominalrupiah" name="nominalrupiah" type="text" class="form-control" placeholder="Masukan 0 jika tidak ada Budget" value="{{ old('nominalrupiah') }}" required>
                                <input id="nominal" type="hidden" class="form-control" type="text" name="nominal" value="{{ old('nominal') }}"/>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="diketahui" id="diketahui" class="form-control select2" required>
                                    ...
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('diketahui') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="disetujui2" id="disetujui2" class="form-control select2">
                                    ...
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('disetujui2') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="diketahui2" id="diketahui2" class="form-control select2">
                                    ...
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('diketahui2') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
