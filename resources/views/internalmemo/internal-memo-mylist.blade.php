                                            ...
                                            <td>
                                                 <div class="dropdown">
                                                     ...
                                                     <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{url('/request/edit', $datas->id )}}">Edit</a></li>
                                                        @if ($datas->status_diketahui == 'BELUM APPROVED')
                                                         @if ($datas->status_disetujui == 'BELUM APPROVED')
                                                            <form method="POST" action="{{ route('request.delete', $datas->id) }}">
                                                                @csrf
...
<script type="text/javascript">
     ...
     $('.show_confirm').click(function(event) {
          ...
          swal({
              title: `Yakin Ingin Menghapus Intenal Memo Ini?`,
              text: "Jika dihapus, internal memo tidak akan ditemukan lagi.",
              icon: "warning",
              buttons: true,
              dangerMode: true,
          })
