...
@section('title') @lang('translation.Mysppd_Listpenerima') @endsection
@section('css')
        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">Untuk Diterima<span class="text-muted fw-normal ms-2">({{$datacount}})</span></h5>
                         </div>
                     </div>
