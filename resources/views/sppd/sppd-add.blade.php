...
@section('title') @lang('translation.Add_SPPD') @endsection
@section('css')
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-10">
                                ...
                                <input id="pekerjaan" name="pekerjaan" type="text" class="form-control"  placeholder="Judul Pekerjaan" value="{{ old('pekerjaan') }}" required>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="tujuan" name="tujuan" type="text" class="form-control" placeholder="Tujuan Kota" value="{{ old('tujuan') }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="penerima_tugas1" id="penerima_tugas1" class="form-control select2" required>
                                    ...
                                    <option value="{{ $user->id }}"
                                        {{ old('penerima_tugas1') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="penerima_tugas3" id="penerima_tugas3" class="form-control select2">
                                    ...
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('penerima_tugas3') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label class="control-label">Tanggal Berangkat dan Kembali</label>
                                    <div class="input-daterange input-group" data-provide="datepicker">
                                        <input type="text" class="form-control" placeholder="Tanggal Berangkat" name="start" />
                                        <input type="text" class="form-control" placeholder="Tanggal Kembali" name="end" />
                                    </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="penerima_tugas2" id="penerima_tugas2" class="form-control select2">
                                    ...
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('penerima_tugas2') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="penerima_tugas4" id="penerima_tugas4" class="form-control select2">
                                    ...
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('penerima_tugas4') == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
