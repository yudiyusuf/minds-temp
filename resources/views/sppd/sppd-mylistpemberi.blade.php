...
@section('title') @lang('translation.Mysppd_Listpemberi') @endsection
@section('css')
                 ...
                 <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             <div>
                                 <a href="{{ route('internalmemo.request.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i>Buat SPPD Baru</a>
                             </div>
                         </div>
