                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="avatar-md mx-auto">
                                                <span class="avatar-title bg-soft-primary rounded-circle">
                                                    <i class="mdi mdi-file-document font-size-24 text-primary"></i>
                                                </span>
                                            </div>
                                            <h5 class="font-size-15 text-uppercase mt-4">
                                                SOP</h5>
                                            <p class="text-muted mb-0"><a href="{{ route('sop.request') }}" target="_blank" rel="noopener noreferrer">Standar Operational Perusahaan</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-15 text-uppercase mt-4">
                                                SPPD</h5>
                                            <p class="text-muted mb-0"><a href="{{ route('sppd.request') }}" target="_blank" rel="noopener noreferrer">Surat Perjalananan Dinas</a></p>
                                        </div>
                                    </div>
                                </div>
