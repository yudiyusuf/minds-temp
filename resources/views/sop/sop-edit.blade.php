                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-10">
                                ...
                                <input id="namasop" name="namasop" type="text" class="form-control"  placeholder="Judul SOP" value="{{ $data->namasop }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="diperiksa" id="diperiksa" class="form-control select2" required>
                                    ...
                                    <option value="{{ $user->id }}"
                                        {{ $data->diperiksa == $user->id ? "selected":"" }}>
                                        {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-12">
                                    ...
                                    <textarea id="ckeditor-classic2" name="kebijakan_spesifik">{{ $data->kebijakan_spesifik }}</textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="mb-12">
                       ...
                       <div class="col-sm-12">
                            <div class="mb-12">
                                    ...
                                    <textarea id="ckeditor-classic" name="tujuan">{{ $data->kebijakan_spesifik }}</textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="mb-12">
                       ...
                       <div class="col-sm-12">
                            <div class="mb-12">
                                    ...
                                    <textarea id="taskdesc-editor" name="ketentuan_proses">{{ $data->ketentuan_proses }}</textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="mb-12">
