                         ...
                         <tbody>
                            @foreach ($data as $datas)
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('images/'. $datas->avatar) }}" alt="" class="avatar-sm rounded-circle me-2">
                                 ...
                                 <td>
                                     <div class="dropdown">
                                         ...
                                         <ul class="dropdown-menu dropdown-menu-end">
                                             <li><a class="dropdown-item" href="{{url('/user/edit', $datas->id )}}">Edit</a></li>
                                         </ul>
                                     </div>
                                 </td>
                             </tr>
...
<script>
    $('#update-passworduser').on('submit', function(event) {
        ...
        $('#signError').text('');
        $.ajax({
            url: "{{ url('update-passworduser') }}" + "/" + Id,
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
