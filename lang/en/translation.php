...
return [
  ...
  "Add_Internalmemo" => "Add Internal Memo",
  "Add_SPPD" => "Add SPPD",
  "Add_Sop" => "Add SOP",
  "Crypto" => "Crypto",
  "Wallet" => "Wallet",
  ...
  "Read_Internalmemo" => "Preview Internal Memo",
  "Read_sppd" => "Preview SPPD",
  "Read_Sop" => "Preview Sop",
  "Templates" => "Templates",
  ...
  "User_Grid" => "User Grid",
  "User_List" => "User List",
  "Mymemo_List" => "My Memo List",
  "Mysppd_List" => "My SPPD List",
  "Mysppd_Listpenerima" => "My SPPD List Penerima",
  "Mysppd_Listforme" => "My SPPD List For Me",
  "Mysppd_Listpemberi" => "My SPPD List Pemberi Tugas",
  "Mysop_List" => "Daftar SOP Saya",
  "Profile" => "Profile",
  "Blog" => "Blog",
  "Blog_List" => "Blog List",
  "Blog_Grid" => "Blog Grid",
